...
export function Layout({ children }: LayoutProps) {
    ...
    const defaultMenus: Menu[] = useMemo(() => [
        ...
        { menu_id: 'HOLIDAY', menu_name: '假日維護', menu_path: '/holidays', icon: '🗓️', sort_order: 5, is_active: true, children: [] },
        { menu_id: 'LEAVE_STATS', menu_name: '休假統計', menu_path: '/leave-stats', icon: '📊', sort_order: 6, is_active: true, children: [] },
